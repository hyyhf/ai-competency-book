...
清华大学刘知远教授在他的《大模型应用开发技术》课程中反复强调："提示词的质量对大模型输出的影响，远大于模型参数规模的差异"[^1]。换句话说，**一个好问题比一个大模型更重要**。
...
Ethan Mollick教授在《Co-Intelligence》中提出了一个实用框架：好的AI请求应该包含足够的**边界条件**，让AI知道在什么范围内工作[^2]。北京师范大学黄荣怀教授的研究团队也发现，在教育场景中，学生提供越明确的任务背景，AI生成的内容质量越高，而且学生对输出的满意度也显著提升[^3]。具体来说：
...
::: info 为什么"限制"反而能提高质量
这听起来反直觉：给AI更多限制，输出反而更好？但这和写作是一样的道理。"写一首诗"比"写一首五言绝句"更难出好作品。约束迫使你（和AI）在有限空间内做取舍，而取舍的过程就是质量产生的过程。心理学家Stokes的研究发现：**适度的约束激发创造力，完全的自由导致平庸**[^4]。中国古典诗歌的层层格律限制——平仄、对仗、韵脚——恰恰是伟大诗篇诞生的土壤，而不是束缚。
:::
...
[^1]: 刘知远. (2024).《大模型应用开发技术》课程讲义. 清华大学计算机系.
